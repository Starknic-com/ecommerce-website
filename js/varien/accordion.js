...
Accordion.prototype = {
    ...
    openSection: function(section) {
        ...
        if(section.id != this.currentSection) {
            ...
            this.adjustFooter(section.id);
        }
    },

    adjustFooter: function(sectionId) {
        if(document.getElementById("footer")) {
            if(sectionId != 'opc-login' &&  sectionId != 'opc-billing' && sectionId != 'opc-shipping' ) {
                   document.getElementById("footer").setAttribute("class", "checkout-footer");
            } else if(sectionId == 'opc-billing'){
            ...
            } else if(sectionId == 'opc-shipping'){
